...
class WelcomeView(LoginRequiredMixin, ListView):
    ...
    def dayly_transactions(self):
        # Create a list of days for the calendar view, where every day is represented as a tuple (day, None/list of transactions)
    ...
    def weeks(self):
        # Split the list of tuples into weeks appropriate to the active month
        # Also create a list of first and last days of next/previous to eventually style differently
